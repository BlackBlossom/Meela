...
(function() {
  ...
  `r`n  // Generate custom order ID in format ORDER-123456 (6 digits)`r`n  function generateOrderId() {`r`n    const randomNum = Math.floor(100000 + Math.random() * 900000); // Generates 6-digit number (100000-999999)`r`n    return 'ORDER-' + randomNum;`r`n  }`r`n`r`n  function showSuccessPopup(orderId) {
